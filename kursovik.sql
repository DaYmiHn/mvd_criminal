...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 08 2019 г., 14:23
...
CREATE TABLE IF NOT EXISTS `Валюта` (
  `Код валюты` bigint(20) NOT NULL,
  `Наименование` varchar(20) NOT NULL,
  `Курс` varchar(50) NOT NULL
...
--
-- Индексы таблицы `Валюта`
--
ALTER TABLE `Валюта`
  ADD PRIMARY KEY (`Код валюты`);
--
-- База данных: `TesTFo`
--
--
...
--
-- Структура таблицы `ures`
--

CREATE TABLE IF NOT EXISTS `ures` (
  `id` int(11) NOT NULL,
  `login` text NOT NULL,
...
--
-- Дамп данных таблицы `ures`
--

INSERT INTO `ures` (`id`, `login`, `password`) VALUES
(1, 'gvbcgh', 546754),
(2, 'cghfg', 435345);
...
--
-- AUTO_INCREMENT для таблицы `ures`
--
ALTER TABLE `ures`
...
(17, 'Sawin_Denis', '25d55ad283aa400af464c76d713c07ad', '', '', '', '', '', '', '', '', NULL),
(18, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Савин', 'Денис', 'Алексеевич', 'Сестрорецк, ул Гагаринская 77к1', 'Майор', '+7(921)871-09-65', '3 года', 'Разлив', 'true'),
(19, 'Osejkin1488', '1bbd886460827015e5d605ed44252251', 'Осейкин', 'Даниил', 'Сергеевич', 'Санкт-Петербург, ул Репищева дом 21', 'Рядовой', '+7(800)555-35-35', '0 лет', 'Коломяги', 'true'),
(23, 'Kuralesov_Fedor', '5e8667a439c68f5145dd2fcbecf02209', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `monday` (`id`, `content`) VALUES
(381, '<a href="" id="381" draggable="false" class="" style=""><strong>Литература</strong>  <br>Читать</a>');
...
--
-- Дамп данных таблицы `RegTest`
--

INSERT INTO `RegTest` (`id`, `login`, `password`, `mail`) VALUES
(1, 'lox', '123', 'lox@yanddex.ru'),
(2, 'lox', '123', 'lox@yanddex.ru');
...
--
-- AUTO_INCREMENT для таблицы `RegTest`
--
ALTER TABLE `RegTest`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;--
-- База данных: `pdd2019`
...
-- Процедуры
--
CREATE DEFINER=`root`@`127.0.0.1` PROCEDURE `tawetae`()
    READS SQL DATA
BEGIN
END$$

CREATE DEFINER=`root`@`127.0.0.1` PROCEDURE `testovaya`(IN `gicha` INT(10))
    READS SQL DATA
BEGIN
SELECT * FROM `test`;
END$$
...
--
-- Структура таблицы `NAz`
--

CREATE TABLE IF NOT EXISTS `NAz` (
  `ID` int(11) NOT NULL,
  `NAME` varchar(20) COLLATE utf8_bin NOT NULL,
  `PRICE` varchar(20) COLLATE utf8_bin NOT NULL,
  `ED_IZM` varchar(20) COLLATE utf8_bin NOT NULL
...
CREATE TABLE IF NOT EXISTS `ZAKAZ` (
  ...
  `name_org` text COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `test` (
  `1` varchar(5) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- AUTO_INCREMENT для таблицы `NAz`
--
ALTER TABLE `NAz`
...
--
ALTER TABLE `ZAKAZ`
  MODIFY `id_zak` int(11) NOT NULL AUTO_INCREMENT;--
-- База данных: `sys`
--
...
--
-- Дублирующая структура для представления `host_summary`
--
...
--
-- Дублирующая структура для представления `host_summary_by_file_io`
--
...
--
-- Дублирующая структура для представления `host_summary_by_file_io_type`
--
...
--
-- Дублирующая структура для представления `host_summary_by_stages`
--
...
--
-- Дублирующая структура для представления `host_summary_by_statement_latency`
--
...
--
-- Дублирующая структура для представления `host_summary_by_statement_type`
--
...
--
-- Дублирующая структура для представления `innodb_buffer_stats_by_schema`
--
...
--
-- Дублирующая структура для представления `innodb_buffer_stats_by_table`
--
...
--
-- Дублирующая структура для представления `innodb_lock_waits`
--
...
--
-- Дублирующая структура для представления `io_by_thread_by_latency`
--
...
--
-- Дублирующая структура для представления `io_global_by_file_by_bytes`
--
...
--
-- Дублирующая структура для представления `io_global_by_file_by_latency`
--
...
--
-- Дублирующая структура для представления `io_global_by_wait_by_bytes`
--
...
--
-- Дублирующая структура для представления `io_global_by_wait_by_latency`
--
...
--
-- Дублирующая структура для представления `latest_file_io`
--
...
--
-- Дублирующая структура для представления `memory_by_host_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `memory_by_thread_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `memory_by_user_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `memory_global_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `memory_global_total`
--
...
--
-- Дублирующая структура для представления `metrics`
--
...
--
-- Дублирующая структура для представления `processlist`
--
...
--
-- Дублирующая структура для представления `ps_check_lost_instrumentation`
--
...
--
-- Дублирующая структура для представления `schema_auto_increment_columns`
--
...
--
-- Дублирующая структура для представления `schema_index_statistics`
--
...
--
-- Дублирующая структура для представления `schema_object_overview`
--
...
--
-- Дублирующая структура для представления `schema_redundant_indexes`
--
...
--
-- Дублирующая структура для представления `schema_table_lock_waits`
--
...
--
-- Дублирующая структура для представления `schema_table_statistics`
--
...
--
-- Дублирующая структура для представления `schema_table_statistics_with_buffer`
--
...
--
-- Дублирующая структура для представления `schema_tables_with_full_table_scans`
--
...
--
-- Дублирующая структура для представления `schema_unused_indexes`
--
...
--
-- Дублирующая структура для представления `session`
--
...
--
-- Дублирующая структура для представления `session_ssl_status`
--
...
--
-- Дублирующая структура для представления `statement_analysis`
--
...
--
-- Дублирующая структура для представления `statements_with_errors_or_warnings`
--
...
--
-- Дублирующая структура для представления `statements_with_full_table_scans`
--
...
--
-- Дублирующая структура для представления `statements_with_runtimes_in_95th_percentile`
--
...
--
-- Дублирующая структура для представления `statements_with_sorting`
--
...
--
-- Дублирующая структура для представления `statements_with_temp_tables`
--
...
('diagnostics.allow_i_s_tables', 'OFF', '2016-06-29 18:44:02', NULL),
('diagnostics.include_raw', 'OFF', '2016-06-29 18:44:02', NULL),
('ps_thread_trx_info.max_length', '65535', '2016-06-29 18:44:02', NULL),
('statement_performance_analyzer.limit', '100', '2016-06-29 18:44:02', NULL),
('statement_performance_analyzer.view', NULL, '2016-06-29 18:44:02', NULL),
('statement_truncate_len', '64', '2016-06-29 18:44:02', NULL);
...
--
-- Дублирующая структура для представления `user_summary`
--
...
--
-- Дублирующая структура для представления `user_summary_by_file_io`
--
...
--
-- Дублирующая структура для представления `user_summary_by_file_io_type`
--
...
--
-- Дублирующая структура для представления `user_summary_by_stages`
--
...
--
-- Дублирующая структура для представления `user_summary_by_statement_latency`
--
...
--
-- Дублирующая структура для представления `user_summary_by_statement_type`
--
...
--
-- Дублирующая структура для представления `version`
--
...
--
-- Дублирующая структура для представления `wait_classes_global_by_avg_latency`
--
...
--
-- Дублирующая структура для представления `wait_classes_global_by_latency`
--
...
--
-- Дублирующая структура для представления `waits_by_host_by_latency`
--
...
--
-- Дублирующая структура для представления `waits_by_user_by_latency`
--
...
--
-- Дублирующая структура для представления `waits_global_by_latency`
--
...
--
-- Дублирующая структура для представления `x$host_summary`
--
...
--
-- Дублирующая структура для представления `x$host_summary_by_file_io`
--
...
--
-- Дублирующая структура для представления `x$host_summary_by_file_io_type`
--
...
--
-- Дублирующая структура для представления `x$host_summary_by_stages`
--
...
--
-- Дублирующая структура для представления `x$host_summary_by_statement_latency`
--
...
--
-- Дублирующая структура для представления `x$host_summary_by_statement_type`
--
...
--
-- Дублирующая структура для представления `x$innodb_buffer_stats_by_schema`
--
...
--
-- Дублирующая структура для представления `x$innodb_buffer_stats_by_table`
--
...
--
-- Дублирующая структура для представления `x$innodb_lock_waits`
--
...
--
-- Дублирующая структура для представления `x$io_by_thread_by_latency`
--
...
--
-- Дублирующая структура для представления `x$io_global_by_file_by_bytes`
--
...
--
-- Дублирующая структура для представления `x$io_global_by_file_by_latency`
--
...
--
-- Дублирующая структура для представления `x$io_global_by_wait_by_bytes`
--
...
--
-- Дублирующая структура для представления `x$io_global_by_wait_by_latency`
--
...
--
-- Дублирующая структура для представления `x$latest_file_io`
--
...
--
-- Дублирующая структура для представления `x$memory_by_host_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `x$memory_by_thread_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `x$memory_by_user_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `x$memory_global_by_current_bytes`
--
...
--
-- Дублирующая структура для представления `x$memory_global_total`
--
...
--
-- Дублирующая структура для представления `x$processlist`
--
...
--
-- Дублирующая структура для представления `x$ps_digest_95th_percentile_by_avg_us`
--
...
--
-- Дублирующая структура для представления `x$ps_digest_avg_latency_distribution`
--
...
--
-- Дублирующая структура для представления `x$ps_schema_table_statistics_io`
--
...
--
-- Дублирующая структура для представления `x$schema_flattened_keys`
--
...
--
-- Дублирующая структура для представления `x$schema_index_statistics`
--
...
--
-- Дублирующая структура для представления `x$schema_table_lock_waits`
--
...
--
-- Дублирующая структура для представления `x$schema_table_statistics`
--
...
--
-- Дублирующая структура для представления `x$schema_table_statistics_with_buffer`
--
...
--
-- Дублирующая структура для представления `x$schema_tables_with_full_table_scans`
--
...
--
-- Дублирующая структура для представления `x$session`
--
...
--
-- Дублирующая структура для представления `x$statement_analysis`
--
...
--
-- Дублирующая структура для представления `x$statements_with_errors_or_warnings`
--
...
--
-- Дублирующая структура для представления `x$statements_with_full_table_scans`
--
...
--
-- Дублирующая структура для представления `x$statements_with_runtimes_in_95th_percentile`
--
...
--
-- Дублирующая структура для представления `x$statements_with_sorting`
--
...
--
-- Дублирующая структура для представления `x$statements_with_temp_tables`
--
...
--
-- Дублирующая структура для представления `x$user_summary`
--
...
--
-- Дублирующая структура для представления `x$user_summary_by_file_io`
--
...
--
-- Дублирующая структура для представления `x$user_summary_by_file_io_type`
--
...
--
-- Дублирующая структура для представления `x$user_summary_by_stages`
--
...
--
-- Дублирующая структура для представления `x$user_summary_by_statement_latency`
--
...
--
-- Дублирующая структура для представления `x$user_summary_by_statement_type`
--
...
--
-- Дублирующая структура для представления `x$wait_classes_global_by_avg_latency`
--
...
--
-- Дублирующая структура для представления `x$wait_classes_global_by_latency`
--
...
--
-- Дублирующая структура для представления `x$waits_by_host_by_latency`
--
...
--
-- Дублирующая структура для представления `x$waits_by_user_by_latency`
--
...
--
-- Дублирующая структура для представления `x$waits_global_by_latency`
--
...
--
-- Структура для представления `host_summary_by_file_io_type`
--
...
--
-- Структура для представления `host_summary_by_stages`
--
...
--
-- Структура для представления `innodb_buffer_stats_by_schema`
--
...
--
-- Структура для представления `innodb_buffer_stats_by_table`
--
...
--
-- Структура для представления `innodb_lock_waits`
--
...
--
-- Структура для представления `io_by_thread_by_latency`
--
...
--
-- Структура для представления `io_global_by_file_by_bytes`
--
...
--
-- Структура для представления `io_global_by_file_by_latency`
--
...
--
-- Структура для представления `io_global_by_wait_by_bytes`
--
...
--
-- Структура для представления `io_global_by_wait_by_latency`
--
...
--
-- Структура для представления `latest_file_io`
--
...
--
-- Структура для представления `memory_by_host_by_current_bytes`
--
...
--
-- Структура для представления `memory_by_thread_by_current_bytes`
--
...
--
-- Структура для представления `memory_by_user_by_current_bytes`
--
...
--
-- Структура для представления `memory_global_by_current_bytes`
--
...
--
-- Структура для представления `memory_global_total`
--
...
--
-- Структура для представления `metrics`
--
...
--
-- Структура для представления `processlist`
--
...
--
-- Структура для представления `ps_check_lost_instrumentation`
--
...
--
-- Структура для представления `schema_auto_increment_columns`
--
...
--
-- Структура для представления `schema_index_statistics`
--
...
--
-- Структура для представления `schema_object_overview`
--
...
--
-- Структура для представления `schema_redundant_indexes`
--
...
--
-- Структура для представления `schema_table_lock_waits`
--
...
--
-- Структура для представления `schema_table_statistics`
--
...
--
-- Структура для представления `schema_table_statistics_with_buffer`
--
...
--
-- Структура для представления `schema_tables_with_full_table_scans`
--
...
--
-- Структура для представления `schema_unused_indexes`
--
...
--
-- Структура для представления `session`
--
...
--
-- Структура для представления `session_ssl_status`
--
...
--
-- Структура для представления `statement_analysis`
--
...
--
-- Структура для представления `statements_with_errors_or_warnings`
--
...
--
-- Структура для представления `statements_with_full_table_scans`
--
...
--
-- Структура для представления `statements_with_runtimes_in_95th_percentile`
--
...
--
-- Структура для представления `statements_with_sorting`
--
...
--
-- Структура для представления `statements_with_temp_tables`
--
...
--
-- Структура для представления `user_summary`
--
...
--
-- Структура для представления `user_summary_by_file_io`
--
...
--
-- Структура для представления `user_summary_by_file_io_type`
--
...
--
-- Структура для представления `user_summary_by_stages`
--
...
--
-- Структура для представления `user_summary_by_statement_latency`
--
...
--
-- Структура для представления `user_summary_by_statement_type`
--
...
--
-- Структура для представления `version`
--
...
--
-- Структура для представления `wait_classes_global_by_avg_latency`
--
...
--
-- Структура для представления `wait_classes_global_by_latency`
--
...
--
-- Структура для представления `waits_by_host_by_latency`
--
...
--
-- Структура для представления `waits_by_user_by_latency`
--
...
--
-- Структура для представления `waits_global_by_latency`
--
...
--
-- Структура для представления `x$host_summary`
--
...
--
-- Структура для представления `x$host_summary_by_file_io`
--
...
--
-- Структура для представления `x$host_summary_by_file_io_type`
--
...
--
-- Структура для представления `x$host_summary_by_stages`
--
...
--
-- Структура для представления `x$host_summary_by_statement_latency`
--
...
--
-- Структура для представления `x$host_summary_by_statement_type`
--
...
--
-- Структура для представления `x$innodb_buffer_stats_by_schema`
--
...
--
-- Структура для представления `x$innodb_buffer_stats_by_table`
--
...
--
-- Структура для представления `x$innodb_lock_waits`
--
...
--
-- Структура для представления `x$io_by_thread_by_latency`
--
...
--
-- Структура для представления `x$io_global_by_file_by_bytes`
--
...
--
-- Структура для представления `x$io_global_by_file_by_latency`
--
...
--
-- Структура для представления `x$io_global_by_wait_by_bytes`
--
...
--
-- Структура для представления `x$io_global_by_wait_by_latency`
--
...
--
-- Структура для представления `x$latest_file_io`
--
...
--
-- Структура для представления `x$memory_by_host_by_current_bytes`
--
...
--
-- Структура для представления `x$memory_by_thread_by_current_bytes`
--
...
--
-- Структура для представления `x$memory_by_user_by_current_bytes`
--
...
--
-- Структура для представления `x$memory_global_by_current_bytes`
--
...
--
-- Структура для представления `x$memory_global_total`
--
...
--
-- Структура для представления `x$processlist`
--
...
--
-- Структура для представления `x$ps_digest_95th_percentile_by_avg_us`
--
...
--
-- Структура для представления `x$ps_digest_avg_latency_distribution`
--
...
--
-- Структура для представления `x$ps_schema_table_statistics_io`
--
...
--
-- Структура для представления `x$schema_flattened_keys`
--
...
--
-- Структура для представления `x$schema_index_statistics`
--
...
--
-- Структура для представления `x$schema_table_lock_waits`
--
...
--
-- Структура для представления `x$schema_table_statistics`
--
...
--
-- Структура для представления `x$schema_table_statistics_with_buffer`
--
...
--
-- Структура для представления `x$schema_tables_with_full_table_scans`
--
...
--
-- Структура для представления `x$session`
--
...
--
-- Структура для представления `x$statement_analysis`
--
...
--
-- Структура для представления `x$statements_with_errors_or_warnings`
--
...
--
-- Структура для представления `x$statements_with_full_table_scans`
--
...
--
-- Структура для представления `x$statements_with_runtimes_in_95th_percentile`
--
...
--
-- Структура для представления `x$statements_with_sorting`
--
...
--
-- Структура для представления `x$statements_with_temp_tables`
--
...
--
-- Структура для представления `x$user_summary`
--
...
--
-- Структура для представления `x$user_summary_by_file_io`
--
...
--
-- Структура для представления `x$user_summary_by_file_io_type`
--
...
--
-- Структура для представления `x$user_summary_by_stages`
--
...
--
-- Структура для представления `x$user_summary_by_statement_latency`
--
...
--
-- Структура для представления `x$user_summary_by_statement_type`
--
...
--
-- Структура для представления `x$wait_classes_global_by_avg_latency`
--
...
--
-- Структура для представления `x$wait_classes_global_by_latency`
--
...
--
-- Структура для представления `x$waits_by_host_by_latency`
--
...
--
-- Структура для представления `x$waits_by_user_by_latency`
--
...
--
-- Структура для представления `x$waits_global_by_latency`
--
